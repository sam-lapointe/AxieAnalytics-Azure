...
def mock_servicebus(mocker):
    ...
    mock_servicebus_client.return_value.__aenter__.return_value = mock_servicebus_instance

    mock_sender = mocker.MagicMock()
    mock_sender.send_messages = mocker.AsyncMock()
    mock_servicebus_instance.get_topic_sender.return_value.__aenter__.return_value = mock_sender
...
def mock_dependencies(mock_config, mock_key_vault_client, mock_get_signing_key, mock_servicebus):
    pass
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            # No logs
            {'webhookId': 'wh_kpy9f3j05p4b3hh8', 'id': 'whevt_fjlzk3zu8uq1p0q1', 'createdAt': '2025-04-10T19:20:21.997Z', 'type': 'GRAPHQL', 'event': {'data': {'block': {'hash': '0xf95b5c3227fc15c4c882f8287b490b99e629dc31dd015da2b7a9d6d4b0ee0f93', 'number': 44153279, 'timestamp': 1744312821}}, 'sequenceNumber': '10000000000632266001', 'network': 'RONIN_MAINNET'}},
            500
        ),
        (
            # No transaction hash in logs[0]
            {'webhookId': 'wh_kpy9f3j05p4b3hh8', 'id': 'whevt_fjlzk3zu8uq1p0q1', 'createdAt': '2025-04-10T19:20:21.997Z', 'type': 'GRAPHQL', 'event': {'data': {'block': {'hash': '0xf95b5c3227fc15c4c882f8287b490b99e629dc31dd015da2b7a9d6d4b0ee0f93', 'number': 44153279, 'timestamp': 1744312821, 'logs': [{'topics': ['0x968d1942d9971cb9c45c722957d854c38f327206399d12ae49ca2f9c5dd06fda'], 'account': {'address': '0xfff9ce5f71ca6178d3beecedb61e7eff1602950e'}}]}}, 'sequenceNumber': '10000000000632266001', 'network': 'RONIN_MAINNET'}},
            500
        ),
        (
            # No block number
            {'webhookId': 'wh_kpy9f3j05p4b3hh8', 'id': 'whevt_fjlzk3zu8uq1p0q1', 'createdAt': '2025-04-10T19:20:21.997Z', 'type': 'GRAPHQL', 'event': {'data': {'block': {'hash': '0xf95b5c3227fc15c4c882f8287b490b99e629dc31dd015da2b7a9d6d4b0ee0f93', 'timestamp': 1744312821, 'logs': [{'topics': ['0x968d1942d9971cb9c45c722957d854c38f327206399d12ae49ca2f9c5dd06fda'], 'account': {'address': '0xfff9ce5f71ca6178d3beecedb61e7eff1602950e'}, 'transaction': {'hash': '0xb05e64ab435371a5c4b6e23f416a37fec881419228db0e35d9b3549204f549eb'}}]}}, 'sequenceNumber': '10000000000632266001', 'network': 'RONIN_MAINNET'}},
            500
        )
    ]
)
async def test_request_body(create_request, valid_ip, request_body, expected_status, signing_key, mock_dependencies):
    headers = {
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {'webhookId': 'wh_kpy9f3j05p4b3hh8', 'id': 'whevt_ynzq5pz452iftsx4', 'createdAt': '2025-04-14T14:26:33.897Z', 'type': 'GRAPHQL', 'event': {'data': {'block': {'hash': '0xe6732b6fd9f74f1196e3011199970edf7d04a9b4901b728910149ea511501029', 'number': 44262595, 'timestamp': 1744640793, 'logs': [{'topics': ['0x968d1942d9971cb9c45c722957d854c38f327206399d12ae49ca2f9c5dd06fda'], 'account': {'address': '0xfff9ce5f71ca6178d3beecedb61e7eff1602950e'}, 'transaction': {'hash': '0xe0e037c4d46a0af225996f837c99a3ddda1cf8cf317780cbbd393b61414818be'}}, {'topics': ['0x968d1942d9971cb9c45c722957d854c38f327206399d12ae49ca2f9c5dd06fda'], 'account': {'address': '0xfff9ce5f71ca6178d3beecedb61e7eff1602950e'}, 'transaction': {'hash': '0x6e74a5ffc57de196ec3bf733f59df20ff786e94d9f490afbf44a443908443200'}}]}}, 'sequenceNumber': '10000000000741595001', 'network': 'RONIN_MAINNET'}},
            [
                {
...
async def test_servicebus_message(create_request, valid_ip, signing_key, request_body, expected_messages, mock_servicebus, mock_dependencies):
    headers = {
        "x-alchemy-signature": sign_request_body(request_body, signing_key),
        "x-forwarded-for": valid_ip
    }
    ...
    mock_servicebus["client"].assert_called_once_with(
        Config.get_servicebus_full_namespace(),
        ANY,
        logging_enable=True
    )
    ...
    mock_servicebus["instance"].get_topic_sender.assert_called_once_with(Config.get_servicebus_topic_name())
    ...
    for sent_message, expected_message in zip(sent_messages, expected_messages):
        ...
        assert isinstance(sent_message, ServiceBusMessage) # Ensure each item is a ServiceBusMessage
        assert sent_message_body == str(expected_message) # Ensure the sent message match the expected message